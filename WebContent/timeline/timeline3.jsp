...
// 			$("#"+testid).attr("action","${path}/timeline.do?method=replyinput");
			$.ajax({
				...
				success:function(data){
					...
					resultcard += '<div class="col s12 m8 offset-m2 l6 offset-l3">';
					resultcard+='<div class="card-panel grey lighten-5 z-depth-1">';
					resultcard+='<div class="valign-wrapper replyimgwrap">';
					resultcard+='<img src="${path}/sampleimg/profile.png" alt="" class="circle replyimg" style="width:40px; height:40px;">';
					resultcard+='<div><i class="material-icons replyfav">favorite_border</i></div>';
		...
		<div class="row timelinebt">
			<div class="test col s3">
				<div class="timelinetop valign-wrapper z-depth-3">
					<img src="${path}/filefolder/${profile}" alt="Contact Person"  class="profileimg">
				</div>
									...
									<c:if test="${not empty tl.reply}">
										<c:forEach var="rep" items="${tl.reply}">
											<div class="col s12 m8 offset-m2 l6 offset-l3">
												<div class="card-panel grey lighten-5 z-depth-1">
													<div class="valign-wrapper replyimgwrap">
															<img src="${path}/sampleimg/profile.png" alt="" class="circle replyimg" style="width:40px; height:40px;">
															<div><i class="material-icons replyfav">favorite_border</i></div>
															<div class="replytext">
																<div>
