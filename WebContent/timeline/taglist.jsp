...
.tagcomment {
	...
	<div class="contents2">
		<div class="container">
			<!-- 반복문으로 출력될  -->
			<c:forEach var="tl" items="${taglist}">
			<div id="bookmark_${tl.no}">
				...
				<div class="timelinebd z-depth-5">
					<div class="timelinebt">
						<div class="dr">
							<i class="material-icons bookmark3" onclick="tagdel(${tl.no})">bookmark</i>
						</div>
						<div class="test valign-wrapper">
							<div class="timelinetop valign-wrapper z-depth-3">
								<img src="${path}/filefolder/${tl.profile}" alt="Contact Person"
									class="profileimg">
							</div>
